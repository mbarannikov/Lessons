...
public class NIOBuffer {
    public static void main(String[] args) {
        ...
        //Java NIO (New IO aka Non-blocking IO) - предназначенн для работы с файловой системой и вводом-выводм.
//        каналы, буферы и селекторы
        ...
        // - SocketChannel - client tcp протокол
        // - ServerSocketChannel - server tcp протокол устанавливает соединение
